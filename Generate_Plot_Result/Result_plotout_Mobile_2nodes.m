function Result_plotout_Mobile_2nodes(T_list, R_list, Phi_list, S_list,n_target)
color_bar1=[0.9,0.5,0.9]*0.9;
color_bar2=[0.9,0.5,0.5]*0.9;
color_bar3=[0.5,0.8,0.9]*0.9;
color_bar4=[0.6,0.6,0.95]*0.8;
% color_bar5=[0.6,0.6,0.95]*0.3;
% color_bar6=[0.6,0.6,0.95]*0.3;
% color_bar7=[0.6,0.6,0.95]*0.3;
transp = 0.3;
