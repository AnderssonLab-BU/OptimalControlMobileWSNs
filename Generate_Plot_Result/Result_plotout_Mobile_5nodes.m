function Result_plotout_Mobile_5nodes(T_list, R_list, Phi_list, S_list,n_target)
color_bar1=[0.9,0.5,0.9]*0.9;
color_bar2=[0.9,0.5,0.5]*0.9;
color_bar3=[0.5,0.8,0.9]*0.9;
color_bar4=[0.6,0.8,0.7]*0.9;
color_bar5=[0.9,0.9,0.3]*0.9;
color_bar6=[0.3,0.3,0.3]*0.5;
...
hold on
plot(T_list,R_list(4,:),'-','color',color_bar4,'LineWidth',2);
hold on
plot(T_list,R_list(5,:),'-','color',color_bar5,'LineWidth',2);
legend('Target1','Target2','Target3','Target4','Target5')
xlabel('Time')
ylabel('Data Volume')
xlim([0,T_list(end)-1.5]);
ylim([0,8]); 
...
hold on
plot(T_list,Phi_list(4,:),'-','color',color_bar4,'LineWidth',2);
hold on
plot(T_list,Phi_list(5,:),'-','color',color_bar5,'LineWidth',2);
legend('Target1','Target2','Target3','Target4','Target5')
xlabel('Time')
...
hold on
x2 = [T_list, fliplr(T_list)];
inBetween = [S_list(5,:) - radius(4), fliplr(S_list(5,:) + radius(4))];
fill(x2, inBetween, color_bar4,'FaceAlpha',transp);
hold on
x2 = [T_list, fliplr(T_list)];
inBetween = [S_list(6,:) - radius(5), fliplr(S_list(6,:) + radius(5))];
fill(x2, inBetween, color_bar5,'FaceAlpha',transp);
hold on

%Plot
plot(T_list,S_list(1,:),'-','color',color_bar6,'LineWidth',2);
hold on
...
hold on
plot(T_list,S_list(5,:),'-','color',color_bar4,'LineWidth',2);
hold on
plot(T_list,S_list(6,:),'-','color',color_bar5,'LineWidth',2);
hold on
plot(T_list,S_list(1,:),'-','color',color_bar6,'LineWidth',2);
legend('Target1','Target2','Target3','Target4','Target5','Agent')
%label
xlabel('Time')
