%Code for PSO method for Data Harvesting Problem with 5 sensor nodes
...
global X_sensing_radius X_target_velocity period_list r  B_list height W_list data_rate_bound

X_target = [3 4 5 5 3.5];
S=[0 10 0 0 0];
u=[1 -1 0 0 0];
...
height = 1;
W_list = [2 3 2 1 3];
X_sensing_radius = [1 2 2 1 2];
data_rate_bound = Generating_data_rate_bound(X_sensing_radius,n_target);
X_target_velocity = [0.9 0.7 0.5 0.4 0.3];
period_list = [1.2 2 5 3 8];
r = [5 8 8 6 7];
R=[0 0 0 0 0];
...
Result_plotout_Mobile_5nodes(T_list, R_list, Phi_list, S_list,n_target);
